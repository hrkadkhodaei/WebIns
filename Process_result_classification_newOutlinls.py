...
dic1 = {
    'DP0': {'Recall': 0.0, 'Precision': 0.0, 'F1-score': 0.0, 'Accuracy-(b)': 0.0},
}
for i in range(1, 9):
    dic1.update({'DP' + str(i): {'Recall': 0.0, 'Precision': 0.0, 'F1-score': 0.0, 'Accuracy-(b)': 0.0}})
...
dic11 = {'Recall': [], 'Precision': [], 'F1-score': [], 'Accuracy-(b)': []}
...
for s in dic11.keys():
    ...
    line, = ax.plot(x, dic11[s],
                    linestyle=linestyles_dict[linestyle[s]], color=colours[s], linewidth=2, label=s)
for s in ['F1-score']:
