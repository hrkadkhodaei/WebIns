...
for InEx in InExs:
    ...
    for i in [1]: #[0, 0.1, 0.2, 0.4]:  # np.arange(0, 0.3, 0.1):
        ...
        with open(fr'd:/xgblss_all/model_{InEx}_zeros_{i}.pkl', 'wb') as f:
        ...
        df_results.to_csv(fr'd:/xgblss_all/{InEx}_zeros_{i}.csv', index=False, header=True)
        # df_res_stats
        # pred_y
